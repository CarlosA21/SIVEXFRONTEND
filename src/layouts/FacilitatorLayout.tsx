...
import HeaderFacilitator from "../components/HeaderFacilitator";

interface VolunteerLayoutProps {
  children: React.ReactNode;
}

const FacilitatorLayout: React.FC<VolunteerLayoutProps> = ({ children }) => {
  ...
  return (
    <div id="wrapper" className="d-flex vh-100">
      ...
      <div id="page-content-wrapper" className="d-flex flex-column flex-grow-1">
        <HeaderFacilitator onToggleMenu={handleToggleMenu}/> {/* Pasar el rol para personalizar el header */}
        <div
