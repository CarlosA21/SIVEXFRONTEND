// // src/components/FacilitatorMyProject.tsx
...
// const FacilitatorMyProject: React.FC = () => {
...
//         // ✅ Esperar a que la actividad se actualice
//         await UpdateActivity(editingActivityId, payload, setLoading);

//         alert("Actividad actualizada correctamente ✅");
//       } else {
//         await CreateActivity(payload, setLoading);
//         alert("Actividad creada correctamente ✅");
//       }

//       // Refrescar proyectos y limpiar el formulario
//       await fetchProjects();
//       setNewActivity({});
...
//         status:
//           (newProject.status as "active" | "inactive" | "completed") || "inactive",
//         // 🔹 Si projectType es un objeto, tomar el name. Si ya es string, usarlo directo
//         projectType:
...
//           </div>
//           <div>
//             <button className="btn btn-primary btn-sm me-1" onClick={() => setSelectedProject(p)}>Ver</button>
//             <button className="btn btn-warning btn-sm" onClick={() => handleEditProject(p)}>Editar</button>
//           </div>
//         </div>
//       </div>
//     ));
...
//         <h2>Módulo de Proyectos - Facilitador</h2>
//         <button
...
//       {/* Modal detalle proyecto y actividades */}
//       {selectedProject && (
...
//                     <li className="list-group-item text-muted">No hay actividades.</li>
//                   )}
...
//                       </div>
//                       <div>
//                         <button className="btn btn-sm btn-outline-primary me-1" onClick={() => handleEditActivity(a)}>Editar</button>
//                         <button className="btn btn-sm btn-outline-danger" onClick={() => handleDeleteActivity(Number(a.id))}>Eliminar</button>
//                       </div>
//                     </li>
//                   ))}
//                 </ul>
...
//                 <button className="btn btn-secondary" onClick={() => { setSelectedProject(null); setEditingActivityId(null); setNewActivity({}); }}>
//                   Cerrar
//                 </button>
//               </div>
//             </div>
...
//                 {/* Título */}
//                 <div className="form-floating mb-2">
//                   <input type="text" className="form-control" placeholder="Título" value={newProject.title || ""} onChange={(e) => setNewProject({ ...newProject, title: e.target.value })} />
//                   <label>Título</label>
//                 </div>
//                 {/* Descripción */}
//                 <div className="form-floating mb-2">
//                   <textarea className="form-control" placeholder="Descripción" style={{ height: "80px" }} value={newProject.description || ""} onChange={(e) => setNewProject({ ...newProject, description: e.target.value })} />
//                   <label>Descripción</label>
//                 </div>
//                 {/* Fecha Inicio */}
//                 <div className="form-floating mb-2">
...
//                 {/* Tipo de Proyecto */}
//                 <div className="form-floating mb-2">
//                   <select className="form-select" value={newProject.projectType || ""} onChange={(e) => setNewProject({ ...newProject, projectType: e.target.value as "extensionism" | "volunteering" })}>
...
//                 {/* Unidad Académica */}
//                 <div className="form-floating mb-2">
//                   <input type="number" className="form-control" placeholder="Unidad Académica" value={newProject.academicUnits?.[0]?.id || ""} onChange={(e) => setNewProject({ ...newProject, academicUnits: [{ id: Number(e.target.value), name: "" }] })} />
//                   <label>ID Unidad Académica</label>
//                 </div>
//               </div>
//               <div className="modal-footer">
//                 <button className="btn btn-secondary" onClick={() => setShowNewProjectModal(false)}>Cancelar</button>
//                 <button className="btn btn-success" onClick={handleSaveProject}>{newProject.id ? "Guardar Cambios" : "Guardar Proyecto"}</button>
//               </div>
//             </div>
//           </div>
//         </div>
...
// export default FacilitatorMyProject;
...
//   // Nueva función para enviar solicitud de aprobación
//   const handleSendApprovalRequest = async (projectId: number) => {
//     try {
//       // Aquí deberías llamar tu servicio API, por ejemplo:
//       // await SendApprovalRequest(projectId);
//       setIsSendingApproval(true);
//       await SendApprovalRequest(projectId, setLoading);

//       alert(`✅ Solicitud de aprobación enviada para el proyecto con ID ${projectId}`);
//     } catch (err: any) {
//       console.error(err);
//       setError(err.message || "Error enviando solicitud de aprobación");
//     }finally{
...
//                 <button
//                   className="btn btn-success"
//                   onClick={() => handleSendApprovalRequest(selectedProject.id)}
//                   disabled = {isSendingApproval}
//                 >
//                   {isSendingApproval ? "Enviando...":"Enviar Solicitud de Aprobacion"}
//                 </button>
//               </div>
//             </div>
//           </div>
