...
const HeaderCoordinator: React.FC<HeaderProps> = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
      <div className="container-fluid">
        <Link className="navbar-brand fw-bold text-primary" to="/dashboardCoordinator">
          Coordinador Sivex
        </Link>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className="nav-link" to="/dashboardCoordinator">Dashboard</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/coordinator_project">Gestión de Solicitudes</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/reportsStatics">Reportes y Estadísticas</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/projectHistory">Historial de Proyectos</Link>
            </li>
          </ul>
